...
export const PROMPT_TEXTS = [
    {
        ...
        text: lines(
            ...
            '',
            '### LOCKED - NEVER CHANGE',
            'Only the player changes these. Do not report them, even when the message describes',
            'somebody as stronger, weaker, sharper or more persuasive - that is description, not a change.',
            '{{locked}}',
            '{{/locked}}',
            '{{notes}}',
            '{{#strangers}}',
            ...
            'A value written as current/maximum keeps that form. A plain number stays a plain',
            'number: never add "/maximum" to it.',
            '{{#reasons}}',
...

    {
        ...
        text: lines(
            ...
            'A value written as current/maximum keeps that form: change the current value, and the maximum only when the story changes it. A plain number stays a plain number.',
            '{{/limits}}',
            '',
            '### COLLECTIONS',
